...
(DONE)This project's first goal is to transition the current python code to golang.
...
During v3.0.0 development, feel free to browse projects at the link below for examples:
...
Below are code practices to consider when rebuilding this project:
